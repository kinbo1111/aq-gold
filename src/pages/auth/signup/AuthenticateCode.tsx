    ...
    return (
        <div className="relative w-full h-screen flex items-center justify-center py-20">
            <div className="max-w-[600px] w-full b-brand-50 rounded-lg p-12">
                ...
                <h6 className="sub-1r gray-800 mb-10 text-center">Enter Authentication Code</h6>
                <p className='text-[20px] text-black mb-10'>
                    Please enter the authentication code (6 numbers) that sent to your email address<br/>
                    and press the "Start AQ GOLD" button.
                </p>
                <form onSubmit={() => {}} className="flex flex-col gap-10">
                <Link to="/auth/signup/confirm-email" className='body-1r text-[#1570EF] underline'>I haven't received an authentication code.</Link>
                <Input
                    id="number"
                    type='number'
