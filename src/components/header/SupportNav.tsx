...
const SupportNav = () => {
  ...
  return (
    <div className="py-2 flex items-center justify-end bg-transparent gap-4">
      <Link to="/" className="body-2b text-white">Help</Link>
        ...
        {isOpen && (
          <div className="absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md overflow-hidden shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button">
            <div className="py-1" role="none">
              <Link to="#" className="block px-4 py-2 text-sm text-white b-gray-600 hover:bg-[#585a5c]" role="menuitem" id="menu-item-0">English</Link>
              <Link to="#" className="block px-4 py-2 text-sm text-white b-gray-600 hover:bg-[#585a5c]" role="menuitem" id="menu-item-1">Japanese</Link>
            </div>
          </div>
        )}
      </div>
